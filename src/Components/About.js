...
import React from 'react';
import { motion } from 'framer-motion';
import { User, Star, Award, Trophy, Download } from 'lucide-react';
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <a
                href="/Vinay_SDE.pdf"
                download
                className="flex items-center gap-3 bg-iron-dark/50 p-4 border border-iron-arc/40 rounded hover:border-iron-arc hover:shadow-[0_0_12px_#00f3ff40] transition-all md:col-span-2"
              >
                <Download className="text-iron-arc" />
                <div>
                  <div className="text-xs font-hud text-gray-500">DOCUMENT</div>
